...
require_relative 'duty_free_spec_migrator'
...
duty_free_migrations_path = File.expand_path("#{db_directory}/migrate/", __FILE__)
::DutyFreeSpecMigrator.new(duty_free_migrations_path).migrate
