...
| 1.0.9          | https://github.com/lorint/duty_free/blob/v1.0.9/README.md |
...
RVM you might have noticed that it won't yet install.  Here's the secret to install Ruby 3.3. First
make sure you're upgraded to the latest stable version of RVM:

    rvm get stable

and then download the .gz file for Ruby 3.3 from:
...
to be a .tar.bz2, which can then be installed:
    ...
    mv ~/Downloads/ruby-3.3.0.tar.gz ~/.rvm/archives/ruby-3.3.0.tar.bz2
